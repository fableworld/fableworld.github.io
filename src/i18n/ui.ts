...
export const ui = {
  en: {
    ...
    'openfable.desc': 'The open-source library for Faba characters. Preview audio, create printable custom cards, and share your stories with the community.',
  ...
  it: {
    ...
    'openfable.title': 'OpenFable',
    'openfable.desc': 'La libreria open source per i personaggi Faba. Ascolta in anteprima, crea custom card stampabili e condividi le tue storie con la community.',
    'fableforge.title': 'FableForge',
